package br.com.monthbalancecontrolandroidapp.ui.balance_time2.balance_timeline;
...
import br.com.monthbalancecontrolandroidapp.databinding.FragmentBalanceTimeline2Binding;
...
import br.com.monthbalancecontrolandroidapp.ui.balance_timeline.BalanceTimelineFragment;

public class BalanceTimelineFragment2 extends Fragment {

    private FragmentBalanceTimeline2Binding binding;
    ArrayList<TimeLineModel> rvList = new ArrayList<>();
    BalanceTimelineFragment.TimeLineAdapter timeLineAdapter;
    RecyclerView rv;
...
//                new ViewModelProvider(this).get(SlideshowViewModel.class);
        ...
        binding = FragmentBalanceTimeline2Binding.inflate(inflater, container, false);
...
//        slideshowViewModel.getText().observe(getViewLifecycleOwner(), textView::setText);
    ...
    private void initLayout() {
        ...
        timeLineAdapter = new BalanceTimelineFragment.TimeLineAdapter(getContext(), rvList);
    ...
    public class TimeLineAdapter extends RecyclerView.Adapter {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            if (viewType == VIEW_TYPE_DEAL_FIRST_ITEM) {
                ...
                return new BalanceTimelineFragment.TimeLineAdapter.FirstDealHolder(view);
            } else if (viewType == VIEW_TYPE_DEAL_MIDDLE_ITEM) {
                view = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.item__card_type_middle, parent, false);
                return new BalanceTimelineFragment.TimeLineAdapter.MiddleDealHolder(view);
            } else if (viewType == VIEW_TYPE_DEAL_LAST_ITEM) {
                view = LayoutInflater.from(parent.getContext())
                        .inflate(R.layout.item_card_end, parent, false);
                return new BalanceTimelineFragment.TimeLineAdapter.LastDealHolder(view);
            }
            return null;
        }
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            ...
            switch (holder.getItemViewType()) {
                case VIEW_TYPE_DEAL_FIRST_ITEM:
                    ((BalanceTimelineFragment.TimeLineAdapter.FirstDealHolder) holder).bind(dealsModel);
                    break;
                case VIEW_TYPE_DEAL_MIDDLE_ITEM:
                    ((BalanceTimelineFragment.TimeLineAdapter.MiddleDealHolder) holder).bind(dealsModel);
                    break;
                case VIEW_TYPE_DEAL_LAST_ITEM:
                    ((BalanceTimelineFragment.TimeLineAdapter.LastDealHolder) holder).bind(dealsModel);
                    break;
            }
        }
